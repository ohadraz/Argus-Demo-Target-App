...
def average_spend_per_item(account: Account) -> int:
    ...
    even where the totals the query returned have drifted from it. The list is
    walked once: re-summing the purchases so far at every purchase would cost
    the square of a shopper's history, and this runs while a page renders.
    """
